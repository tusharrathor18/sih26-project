"""
Django settings for Legal Metrology Compliance Inspection System.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'legal_metrology'),
...
# Media uploads (commodity scan images)
MEDIA_URL = 'media/'
...
# Deployment hardening remains opt-in so local HTTP development continues to work.
